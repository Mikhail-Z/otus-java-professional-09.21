package ru.calculator.after;

import ru.calculator.before.Data;
...
public class Summator {
    ...
    private final List<ru.calculator.after.Data> listValues = new ArrayList<>();

    //!!! сигнатуру метода менять нельзя
    public void calc(ru.calculator.after.Data data) {
        listValues.add(data);
