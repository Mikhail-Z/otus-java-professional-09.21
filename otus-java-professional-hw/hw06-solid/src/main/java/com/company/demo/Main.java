...
import com.company.core.providers.factories.DefaultBankProviderFactory;
import com.company.core.services.BankNotesManager;
import com.company.core.services.DefaultBankNotesManager;
...
public class Main {
    public static void main(String[] args) {
        ...
        BankNotesManager bankNotesManager = new DefaultBankNotesManager(Set.of(new BankNoteDenomination[]{
        ...
        BankProviderFactory factory = new DefaultBankProviderFactory(Set.of(new TestBankProvider()));
