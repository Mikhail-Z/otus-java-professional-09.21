...
import ru.otus.jdbc.mapper.utils.FieldValuesExtractorImpl;
import ru.otus.jdbc.mapper.utils.ResultSetMapperImpl;
...
// Работа с клиентом
        ...
        var dataTemplateClient = new DataTemplateJdbc<>(
                ...
                new ResultSetMapperImpl<>(entityClassMetaDataClient),
                new FieldValuesExtractorImpl<>(entityClassMetaDataClient)); //реализация DataTemplate, универсальная
...
// Сделайте тоже самое с классом Manager (для него надо сделать свою таблицу)
        ...
        var dataTemplateManager = new DataTemplateJdbc<>(
                ...
                new ResultSetMapperImpl<>(entityClassMetaDataManager),
                new FieldValuesExtractorImpl<>(entityClassMetaDataManager));
