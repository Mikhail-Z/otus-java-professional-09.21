...
class DbServiceClientTest extends AbstractHibernateTest {
    ...
    void shouldCorrectSaveClient() {
        ...
        //then
        var loadedSavedClient = clientService.getClient(savedClient.getId());
        ...
        clientService.saveClient(savedClientUpdated);

        //then
        var loadedClient = clientService.getClient(savedClientUpdated.getId());
