...
import com.company.utils.FileSystemHelper;
import com.company.services.TemplateProcessor;
import com.company.servlet.ClientApiServlet;
import com.company.servlet.ClientServlet;
...
public class ClientWebServerSimple implements ClientWebServer {
    ...
    public ClientWebServerSimple(int port, ClientService clientService, Gson gson, TemplateProcessor templateProcessor) {
